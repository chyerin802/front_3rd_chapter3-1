...
describe('formatWeek', () => {
  ...
  it('월의 첫 주 날짜에 대해 올바른 주 정보를 반환한다', () => {
    const date = new Date('2024-11-03');
    expect(formatWeek(date)).toBe('2024년 11월 1주');
  });

  it('월의 마지막 주 날짜에 대해 올바른 주 정보를 반환한다', () => {
    const date = new Date('2024-11-30');
    expect(formatWeek(date)).toBe('2024년 11월 4주');
  });
  ...
  it('평년 2월의 마지막 주에 대해 올바른 주 정보를 반환한다', () => {
    const date = new Date('2023-02-28'); // 평년 2월 28일
